							...
							<div class="mailbox-content">
								<table class="table table-fhr">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a onclick="if (confirm('Delete this message?')) commentDelete(1); return false" href="<?php echo base_url() ?>message/delete/<?php echo $m['id_message'] ?>"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    <?php 
                                      $num++;
