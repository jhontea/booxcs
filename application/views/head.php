...
<html>
    ...
    Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
        ...
        <!-- jQuery -->
        <!-- lined-icons -->
        <link rel="stylesheet" href="<?php echo base_url() ?>application/assets/css/icon-font.min.css" type='text/css' />
        ...
        <!--animate-->
        <link href="<?php echo base_url() ?>application/assets/css/animate.css" rel="stylesheet" type="text/css" media="all">
        ...
        <!-- Meters graphs -->
        <script src="<?php echo base_url() ?>application/assets/js/jquery-1.10.2.min.js"></script>
